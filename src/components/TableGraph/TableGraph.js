...
const TableGraph = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(process.env.REACT_APP_BASE_URL + "/graph")
      .then((response) => {
      ...
      <div className="container" style={{ padding: "50px 0 50px" }}>
        <div className="offset-0 col-12">
          <div
            ...
            className=" card d-flex flex-column flex-wrap align-items-center w-100 p-4"
          >
      ...
      >
        <div>
          <Box sx={{ ...style, width: 800 }}>
            ...
            <CustomChartMAxis chartLables={chartLables} dataSets={dataSets} />
